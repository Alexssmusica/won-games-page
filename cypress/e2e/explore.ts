...
describe('Explore Page', () => {
	...
	it('should show 12 games and show more games when show more is clicked', () => {
	...
	it('should order by price', () => {
		...
		cy.getByDataCy('game-card').first().within(() => {
			cy.findByText(/free of charge/i).should('exist')
		})
