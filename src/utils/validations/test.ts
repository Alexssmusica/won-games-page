...
describe('validations', () => {
	describe('signInValidate()', () => {
		...
		it('should return invalid email error', () => {
			...
			expect(signInValidate(values).email).toMatchInlineSnapshot(`"\\"email\\" must be a valid email"`);
		});
	});
	...
	describe('signUpValidate()', () => {
		...
		it('should return invalid email error', () => {
			...
			expect(signUpValidate(values).email).toMatchInlineSnapshot(`"\\"email\\" must be a valid email"`);
		});
	...
	describe('forgotValidate()', () => {
		...
		it('should return invalid email error', () => {
			...
			expect(forgotValidate(values).email).toMatchInlineSnapshot(`"\\"email\\" must be a valid email"`);
		});
	});
